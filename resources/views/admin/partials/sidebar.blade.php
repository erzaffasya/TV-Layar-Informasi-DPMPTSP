<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="Layanan-nav" class="nav-content {{ request()->is('Layanan*') ? 'show' : '' }} collapse "
                data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('Layanan.create') }}"
                        class="{{ request()->is('Layanan/create') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            ...
            <ul id="Informasi-nav" class="nav-content {{ request()->is('Informasi*') ? 'show' : '' }} collapse "
                data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('Informasi.create') }}"
                        class="{{ request()->is('Informasi/create') ? 'active' : '' }}">
